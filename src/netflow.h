...
#define NETFLOW_HTTP_HOST 8001
#define NETFLOW_HTTP_HOST_SIZE 64

#define NETFLOW_HTTP_REFERER 8002
#define NETFLOW_HTTP_REFERER_SIZE 256

#define NETFLOW_HTTP_URI 8003
#define NETFLOW_HTTP_URI_SIZE 384
...
#define NETFLOW5_MAX_FLOWS 1
#define NETFLOW5_FLOW_SIZE 48
#define NETFLOW5_HTTPINFO_SIZE (NETFLOW_HTTP_HOST_SIZE \
		 + NETFLOW_HTTP_URI_SIZE + NETFLOW_HTTP_REFERER_SIZE) 
